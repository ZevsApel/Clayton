...
$(".menu-icon").click(() => {
    $(".mobile-menu-nav").toggleClass("show-menu");


    if (!isTransformed) {
        $('#dot1, #dot4').addClass('transform');
        $('#dot2, #dot3').addClass('transform');
    } else {
        $('#dot1, #dot4').removeClass('transform');
        $('#dot2, #dot3').removeClass('transform');
    }
